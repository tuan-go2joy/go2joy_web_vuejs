            ...
            <div class="breadcrumbbar">
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-8">
                        <h4 class="page-title">{{$t('breadcrumb.dashboard')}}</h4>
                        <div class="breadcrumb-list">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="dashboard">{{$t('breadcrumb.home')}}</a></li>
                                <li class="breadcrumb-item active" aria-current="page">{{$t('breadcrumb.dashboard')}}</li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card m-b-30">
                                    <div class="card-header">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-5">
                                                <button class="btn btn-primary-rgba float-right font-13">View All</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
