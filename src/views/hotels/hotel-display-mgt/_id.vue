                ...
                <div class="row input-padding">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row col-md-12" v-if="radio == 1">
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.ez_cloud')"></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.bhotel_easy')"></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.hbsoft_hotel')"></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.ohotel')"></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.sky_hotel')"></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.intellio')"></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.fotel')"></el-checkbox>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="row col-md-12" v-if="radio == 2">
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.ez_cloud')" disabled></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.bhotel_easy')" disabled></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.hbsoft_hotel')" disabled></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.ohotel')" disabled></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.sky_hotel')" disabled></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.intellio')" disabled></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.fotel')" disabled></el-checkbox>
                            </div>
                            <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row col-md-12" v-if="radio == 2">
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.excel')"></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.notebook')"></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.google_sheet')"></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-input type="text"></el-input>
                            </div>
                        ...
                        <div class="row col-md-12" v-if="radio == 1">
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.excel')" disabled></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.notebook')" disabled></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-checkbox :label="$t('table.hotels.create_hotel_display.google_sheet')" disabled></el-checkbox>
                            </div>
                            <div class="col-md-3">
                                <el-input type="text" disabled></el-input>
                            </div>
    ...
    async created() {
        ...
        await axios.get(url)
            .then(function (response) {
                self.user = response.data.data.hotels
                self.loading = false;
            })
            .catch(error => {
                console.log(error);
